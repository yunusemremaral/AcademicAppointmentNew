        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className={`bg-gradient-to-br from-white/5 to-white/2 rounded-lg p-4 flex items-center justify-center flex-grow backdrop-blur-sm ${themeColors.primary.border}`}>
            <div className="text-center">
              ...
              <p className={`${themeColors.primary.textLight}/80 text-[11px] font-light max-w-xs mx-auto leading-relaxed`}>
                Akademisyen yönetim panelinin kullanımı, randevu onaylama ve takvim yönetimi hakkında detaylı bilgi için tanıtım videosunu izleyebilirsiniz
              </p>
